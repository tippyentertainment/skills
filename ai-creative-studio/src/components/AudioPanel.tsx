...
export function AudioPanel({ onGenerate }: Props) {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <h2 className="text-3xl font-bold mb-6">🎵 Audio Generation</h2>
      ...
      <div className="bg-gray-800/50 rounded-2xl p-6 space-y-6">
        <div>
          ...
          <textarea
            ...
            placeholder="Describe the audio or music you want to create..."
